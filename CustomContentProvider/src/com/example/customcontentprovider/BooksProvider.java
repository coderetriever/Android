...
public class BooksProvider extends ContentProvider
{
	...
	public int delete(Uri arg0, String arg1, String[] arg2) {
		...
		//This will notify registered observers that a row was deleted
		getContext().getContentResolver().notifyChange(arg0, null);
		return count;
	}

	//override the getType() method to uniquely describe the data type for your content provider
	@Override
	...
	//overrode the onCreate() method to open a connection to the database when the content provider is started
	@Override
	...
	//overrode the query() method to allow clients to query for books
	@Override
